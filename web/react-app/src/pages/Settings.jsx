                    ...
                    <div className="grid grid-cols-3 gap-2">
                        {PRESETS.map(preset => (
                            ...
                            >
                                ...
                                <span className="preset-card-content text-[18px] font-bold text-[#f0f0f0] truncate w-full text-left">{preset.name}</span>
                        ...
                        >
                            ...
                            <span className="preset-card-content text-[18px] font-bold text-[#f0f0f0] text-left">Custom</span>
